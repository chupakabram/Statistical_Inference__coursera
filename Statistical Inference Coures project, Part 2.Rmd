...
The p-value is `r ttest$p.value`; it is small, but still greater then $\alpha$ (0.05). It means we **can not reject** $H_0$ hypothesis, i.e we can't say with full confidence the parameter **supp** affects on **len**. 
