---
title: "Statistical Inference Coures project, Part 1"
...
##Conclusion:   
 - The sample average variance decreases when size of sample is growing up;
 - As we can see the sample average distribution is pretty close to normal one, the difference between obtained and theoretical values are about 0.1%. 
